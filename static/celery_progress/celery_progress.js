class CeleryProgressBar {
    ...
    constructor(progressUrl, options) {
        ...
        let barColorsDefault = {
            ...
            ignored: 'rgba(0, 0, 0, 0)'
        }
        this.barColors = Object.assign({}, barColorsDefault, options.barColors);

        let defaultMessages = {
            waiting: 'patience is a virtue you know...',
            started: 'all good things come to those who wait...'
        }
    ...
    onErrorDefault(progressBarElement, progressBarMessageElement, excMessage, data) {
        ...
        progressBarMessageElement.textContent = "Uh-Oh, something went wrong! Reload the page" + excMessage;
    }
    ...
    onProgressDefault(progressBarElement, progressBarMessageElement, progress) {
        ...
        if (progress.current == 0) {
            ...
            progressBarMessageElement.textContent = (progress.current/progress.total)*100 + '% of ' + ' activities loaded.';
        }
    }
